...
# 应返回 {"ok":true,"service":"whatsapp-webhook","build":"v5"}
```
...
- 如果配了 RMC secrets，到 RMC `public.resumes` 表里能查到 `whatsapp = +5218132689146` 这条候选人，`storage_path` 指向 RMC 的 `resumes/whatsapp/...`
